...
#contact-form{
    ...
    <div class="main">
        ...
        <section class="pb-12 md:pb-20 pt-12 md:pt-20 mx-auto" style="margin-bottom: 32px;">
            ...
            <form action="{{ route('sendManualEmail') }}" method="POST" id="contact-form" class="max-w-lg mx-auto p-6 bg-white  rounded-lg">
                @csrf
                <h3 class="text-center text-3xl font-semibold text-black pb-5 md:pb-5" style="margin-top: 26px;">Contact us</h3>

                @if (session()->has('success'))
                    <div class="bg-green-500 p-2 text-center text-white rounded mb-4">
                        {{ session()->get('success') }}
                    </div>
                @endif
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" id="name" name="name" required class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" />
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <input type="tel" id="number" name="number" class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" />
                    </div>
            
                    <!-- Message Field -->
                    <div class="col-span-1 md:col-span-2">
                        <label for="message" class="block text-sm font-medium text-gray-700">Message</label>
                        <textarea id="message" name="message" rows="4" required class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"></textarea>
                    </div>
                </div>
            
                <!-- Submit Button -->
                <button type="submit" class="mt-4 w-full bg-blue-600 text-white font-semibold p-3 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Send
                </button>
            </form>
