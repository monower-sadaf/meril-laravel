...
@section('content')
    ...
    <div class="main">
            ...
            <div class="h-full bg-gradient-to-r from-[rgba(15,39,122,0.80)] to-[rgba(201,26,96,0.80)]">
                <div class="container mx-auto h-full flex items-center justify-center">
                    <div class="text-center">
                        <h1 class="text-4xl font-bold text-white">About us - We As Your Team</h1>
                    </div>
                </div>
            </div>
        </section>
        <section class="pb-[50px] pt-[50px]" style="text-align: -webkit-center;">
            ...
            <br>
            <p style="font-style: italic;color: #354e8e;font-size: x-large;"><span>*</span>Merilsoft is powered by its partner’s resources, expertise, and experience at the backend.</p>
