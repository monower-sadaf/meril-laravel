...
<head>
    ...
    <!--title-->
    <title>Merilsoft Consultancy Services | Information technology consulting, marketing, outsourcing services and software development company</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-7">
                            <div class="page-header-content text-center">
                                <h1>Merilsoft Technologies</h1>
                                <p>Providing our clients with exceptional marketing, technology, and advisory services.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="section-heading text-center mb-5">
                            <h2>What We Do?</h2>
                            <p class="lead">We are a US-based consulting firm focused on strategy, technology, and business transformation. We help 
                            companies achieve their goals by tackling their most challenging and ambitious projects, enabling their teams to 
                            scale up and down in key times with expert skills.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 mb-md-4 mb-lg-0">
                        <div class="feature-widget text-center p-4">
                            ...
                            <div class="widget-text">
                                <h3 class="h5">Strategy</h3>
                                <p class="mb-0">Strategize and create an easy-to-follow roadmap.</p>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 mb-md-4 mb-lg-0">
                        <div class="feature-widget text-center p-4">
                            ...
                            <div class="widget-text">
                                ...
                                <p class="mb-0">This is where your roadmap meets reality.</p>
